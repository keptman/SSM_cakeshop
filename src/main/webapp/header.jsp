		...
		<div class="container">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav"> 
									...
									<div class="row">
										<div class="col-sm-12">
											...
											<ul class="multi-column-dropdown">
													...
													<li><a class="list" href="${pageContext.request.contextPath }/goods/goods-tList?id=${t.id}">${t.name }</a></li>
													</c:forEach>
											</ul>
										</div>	
									</div>
						...
						<c:choose><c:when test="${empty loginuser }">
							...
							<li><a href="${pageContext.request.contextPath }/goods/order_list" <c:if test="${param.flag==5 }">class="active"</c:if>>我的订单</a></li>
						...
						<c:if test="${!empty  loginuser  &&  loginuser .isadmin }">
			...
			<div class="header-info">
				<div class="header-right search-box">
					...
					<div class="search">
						<form class="navbar-form" action="${pageContext.request.contextPath }/goods/goods_search">
				...
				<div class="header-right cart">
					<a href="${pageContext.request.contextPath }/goods/goods_cart">
