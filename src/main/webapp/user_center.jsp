			...
			<div class="register">
				...
				<c:if test="${!empty failMsg }">
					...
					<div class="register-top-grid">
						<h3>个人中心</h3>
						<form action="${pageContext.request.contextPath }/user/user_changeaddress" method="post">
						<!-- 收货信息 start -->
						<h4>收货信息</h4>
						<div class="input">
						...
						<hr>
						<form action="${pageContext.request.contextPath }/user/user_changepwd" method="post">
						<h4>安全信息</h4>
						<div class="input">
							<span>原密码</span>
							<input type="text" name="password1" placeholder="请输入原密码">
						</div>
						<div class="input">
							<span>新密码</span>
